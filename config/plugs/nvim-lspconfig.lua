...
local servers = { 'tsserver', 'jsonls', 'html', 'elmls', 'gopls', 'vimls', 'csharp_ls' }

require("mason").setup()
require("mason-lspconfig").setup {
  ensure_installed = { "tsserver", "jsonls", "vimls", "csharp_ls" },
...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(args)
    ...
    -- Refactor
    keymap.set('n', '<space>rn', vim.lsp.buf.rename, desc('Rename Buffer'))
    keymap.set('n', 'cr', vim.lsp.buf.rename, desc('Rename Buffer'))
